    ...
    <div class="local-container">
        <div class="buttons-library">
            ...
            <button class="btn__filter">
                <p class="btn__filter-txt">Filter</p>
                <div class="btn__filter-arrow"></div>
            </button>

            <button class="btn__gray">
                <p class="btn__gray-txt">Filter</p>
                <div class="btn__gray-line"></div>
            </button>

            <button class="btn__gray-ver">
                <p class="btn__gray-txt">Filter</p>
        ...
        <div class="issue-selector">
            <div class="issue-heading">
                <img src="@/assets/icons/change-issue-style.svg" alt="">
                <h2 class="issue-heading__heading">Common issues</h2>
            </div>
            <div class="issue-selector__container">
                <nav class="issue-nav">
                    <ul class="issue-list">
                        <li class="issue-link">
                            <button class="btn__gray-ver">
                                <p class="btn__gray-txt">Filter</p>
                                <div class="btn__gray-line-hor"></div>
...
<style scoped>
    ...
    .btn__filter-arrow {
        width: 1rem;
        height: 1rem;
        border-bottom: solid .15rem var(--color-white);
        border-right: solid .15rem var(--color-white);
    ...
    .btn__filter:hover .btn__filter-arrow {
        border-bottom: solid .15rem var(--color-brand);
        border-right: solid .15rem var(--color-brand);
    }
    ...
    .btn__gray:focus .btn__gray-line,
    .btn__gray-ver:focus .btn__gray-line-ver {
        background-color: var(--color-brand);
    } */
    ...
    .issue-selector__container {
        display: grid;
        grid-template-columns: repeat(10, 1fr);
        grid-template-rows: auto;
        grid-template-areas: 
        "btn btn info info info info img img img img"
        ;
    }
    ...
    .btn__gray-ver:hover .btn__gray-line-ver {
            display: flex;
        }
